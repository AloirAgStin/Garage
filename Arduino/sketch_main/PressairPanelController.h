...
const short g_countNextListenItemPressair = 8 + 1;



class CPressairPanelController : public CNexPageEx
{
    friend class CMainAppl;

public:

    CPressairPanelController(uint8_t pageID, uint8_t objID, const char *pageName, CSendCmd * _SerialCmd);
...
public:
    ...
    NexTouch* m_nex_listen_list[g_countNextListenItemPressair];
